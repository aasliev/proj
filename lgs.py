...
def getData():
    allurls = '/Users/Asliddin/Desktop/research/data_updated.txt'	#path to our all urls file
    ...
    blacklistPath = '/Users/Asliddin/Desktop/research/blacklist.txt'
...
def main():
    ...
    for i in range(len(X_test)):
        if X_test[i] in blacklist:
            ...
            y_pred.append(int(lgs.predict(vec[i])))
    ...
    results = cross_val_score(estimator = lgs, X= X_train, y=y_train, cv =10)
